// :sentinel-maps — capability module. Compiled into the consumer build
// ONLY when the `maps` capability (Cargo feature) is enabled.
plugins {
...
// back to the in-tree android/builds/maps for workspace/path-dependency dev.
val sentinelBuildRoot = project.findProperty("sentinelBuildRoot") as String?
layout.buildDirectory.set(
    if (sentinelBuildRoot != null) file("$sentinelBuildRoot/maps")
    else file("$projectDir/../../builds/maps")
)

android {
    namespace = "com.mobilesentinel.maps"
    compileSdk = 34
