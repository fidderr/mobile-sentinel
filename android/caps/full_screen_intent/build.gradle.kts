...
// back to the in-tree android/builds/full_screen_intent for workspace/path-dependency dev.
val sentinelBuildRoot = project.findProperty("sentinelBuildRoot") as String?
layout.buildDirectory.set(
    if (sentinelBuildRoot != null) file("$sentinelBuildRoot/full_screen_intent")
    else file("$projectDir/../../builds/full_screen_intent")
)
